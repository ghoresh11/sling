...
def run():
    parser = argparse.ArgumentParser(
        ...
        usage = 'sling group [options] <filter_id> <group_id> <req>')
    ...
    parser.add_argument('-t','--order', type=str, help = 'Location of partner gene relative to hit if overriding <req_file>. Options: upstream, downstream, either, both [%(default)s]', metavar='STR', default=None)
    ...
    parser.add_argument('req', help='The name of one of the predefined databases OR a path to a requirement file for custom DBs', metavar='STR/FILE')
